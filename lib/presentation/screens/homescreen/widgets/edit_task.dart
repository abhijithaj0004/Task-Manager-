        ...
        TextButton(
            onPressed: () {
              if (formKey.currentState!.validate()) {
                ...
                String newdate = context.read<UpdateListCubit>().state.date;
                final taskModel = TaskModel(
                    title: newTitle, description: newDes, dueDate: newdate);
                context.read<TaskManagerCubit>().updateTask(id, taskModel);
              }
